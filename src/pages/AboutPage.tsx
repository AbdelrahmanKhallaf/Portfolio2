...
const age = calculateAge(2006, 7, 9);
const AboutPage: React.FC = () => {
  ...
  const personalInfo = [
    ...
    },
    {
      ...
      description: "Student in Beni-Suef National University (2024–2028)",
    },
    {
      icon: Briefcase,
      label: "Current Role",
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Full Stack Developer | Data scientist & Analyst | Problem Solver | Lifelong Learner
            </p>
          </motion.div>
            ...
            >
              <div>
                <h2 className="text-3xl font-bold mb-6 text-white">
                  AI Engineer & Data Scientist & Full Stack
                </h2>
                <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
                  <p>
                    I’m a passionate 19-year-old AI Engineer and Data Scientist
                    based in Beni-Suef , Egypt, currently pursuing my BSc in
