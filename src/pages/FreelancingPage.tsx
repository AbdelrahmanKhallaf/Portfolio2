...
const FreelancingPage: React.FC = () => {
  ...
  const freelanceProjects = [
    ...
    },
    {
      ...
      period: "2025 - Present",
      description:
        "Designed and implemented custom Web to meet client-specific needs across various industries.",
      achievements: ["Delivered 10+ custom for different clients"],
      skills: [
        "Frontend",
        "Backend",
        "Framework",
