      ...
      skills: [
        {
          name: "Frontend & React ",
          description:
            "Front-End Developer specialized in building responsive, interactive web interfaces using modern JavaScript frameworks.",
        ...
        },
        {
          name: "Backend ",
          description:
            "Back-End Developer focused on building secure, scalable, and high-performance server-side applications",
          technologies: ["JavaScript","TypeScript","Python","NodeJS","Django"],
          experience: "1+ years",
        },
