...
const EducationPage: React.FC = () => {
  const education = {
    ...
    specialization: "Double Major: AI & Medical",
    institution: "Beni-Suef National University",
    location: "Beni-Suef, Egypt",
    period: "2024 - 2028",
    description:
      "Comprehensive Double Major Program Covering Artificial Intelligence and Medical Informatics, Including Machine Learning, Deep Learning, Natural Language Processing, Predictive Analytics, Big Data Management, Statistical Modeling, and Ethical AI Applications.",
    gpa: "very good",
  ...
  const certifications = [
    {
      ...
      issuer: "College of Computer Science and Artificial Intelligence",
      year: "2025",
      type: "Professional Certification",
    },
    {
      title: "CS50X From Harvard University",
      issuer: "Harvard University",
      year: "2025",
      type: "Professional Certification",
    },
    {
      title: "CS50P:Programming using Python",
      issuer: "Harvard University",
      year: "2025",
      type: "Professional Certification"
    },
    {
      title: "CS50 AI:Artificial Intelligence Using Python",
      issuer: "Harvard University",
      year: "2025",
      type: "Professional Certification"
    },
