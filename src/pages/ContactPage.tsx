  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "abdokhallaf121@gmail.com",
      href: "mailto:abdokhallaf121@gmail.com",
    ...
    },
    {
      ...
      label: "Phone",
      value: "+201156848662",
      href: "tel:+201156848662",
      description: "Available for urgent matters",
    },
    {
      icon: MapPin,
      label: "Location",
      value: "Beni-Seuf, Egypt",
      href: "#",
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      value: "@Abdelrahman Khallaf",
      href: "https://github.com/AbdelrahmanKhallaf",
      description: "View my code repositories",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "/in/ِabdelrahman Khallaf",
      href: "https://www.linkedin.com/in/abdelrahmankhallaf/",
    ...
    },
    {
      ...
      href: "https://drive.google.com/drive/folders/1SeLEOgXfTSpmzXU-Ps4QqwzR9do7mdrq?usp=drive_link",
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Ready to collaborate on Web projects or discuss opportunities?
          ...
          >
            <div className="bg-zinc-900 rounded-lg p-8 border border-zinc-800">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Open to exciting Web projects, data challenges, and creative
